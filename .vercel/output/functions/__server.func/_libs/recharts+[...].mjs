...
var Surface = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	var children = props.children, width = props.width, height = props.height, viewBox = props.viewBox, className = props.className, style = props.style, title = props.title, desc = props.desc, others = _objectWithoutProperties$26(props, _excluded$26);
	var svgView = viewBox || {
		width,
		height,
		x: 0,
	...
	return /*#__PURE__*/ import_react.createElement("svg", _extends$29({}, svgPropertiesAndEvents(others), {
...
var Layer = /*#__PURE__*/ import_react.forwardRef((props, ref) => {
	var children = props.children, className = props.className, others = _objectWithoutProperties$25(props, _excluded$25);
	var layerClass = clsx("recharts-layer", className);
	return /*#__PURE__*/ import_react.createElement("g", _extends$28({ className: layerClass }, svgPropertiesAndEvents(others), { ref }), children);
});
//#endregion
...
var getCartesianPosition = (options) => {
	...
	if (position === "insideLeft") return _objectSpread$43({
		x: middleX + horizontalOffset,
		y: y + height / 2,
		horizontalAnchor: horizontalStart,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideRight") return _objectSpread$43({
		x: middleX + midHeightWidth - horizontalOffset,
		y: y + height / 2,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideTop") return _objectSpread$43({
		x: upperX + upperWidth / 2,
		y: y + verticalOffset,
		horizontalAnchor: "middle",
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottom") return _objectSpread$43({
		x: lowerX + lowerWidth / 2,
		y: y + height - verticalOffset,
		horizontalAnchor: "middle",
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideTopLeft") return _objectSpread$43({
		x: upperX + horizontalOffset,
		y: y + verticalOffset,
		horizontalAnchor: horizontalStart,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideTopRight") return _objectSpread$43({
		x: upperX + upperWidth - horizontalOffset,
		y: y + verticalOffset,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottomLeft") return _objectSpread$43({
		x: lowerX + horizontalOffset,
		y: y + height - verticalOffset,
		horizontalAnchor: horizontalStart,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideBottomRight") return _objectSpread$43({
		x: lowerX + lowerWidth - horizontalOffset,
		y: y + height - verticalOffset,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (!!position && typeof position === "object" && (isNumber(position.x) || isPercent(position.x)) && (isNumber(position.y) || isPercent(position.y))) return _objectSpread$43({
		x: x + getPercentValue(position.x, midHeightWidth),
		y: y + getPercentValue(position.y, height),
		horizontalAnchor: "end",
		verticalAnchor: "end"
	}, sizeAttrs);
	return _objectSpread$43({
		x: centerX,
		y: y + height / 2,
		horizontalAnchor: "middle",
		verticalAnchor: "middle"
...
var Symbols = (_ref) => {
	...
	var props = _objectSpread$42(_objectSpread$42({}, _objectWithoutProperties$24(_ref, _excluded$24)), {}, {
		type,
		size,
		sizeType
	});
	...
	*/
	...
	if (isNumber(cx) && isNumber(cy) && isNumber(size)) return /*#__PURE__*/ import_react.createElement("path", _extends$27({}, filteredProps, {
...
function resolveDefaultProps(realProps, defaultProps) {
	var resolvedProps = _objectSpread$41({}, realProps);
	var dp = defaultProps;
...
function Icon(_ref) {
	...
	if (/*#__PURE__*/ import_react.isValidElement(data.legendIcon)) {
		var iconProps = _objectSpread$40({}, data);
...
function Items(props) {
	...
	return payload.map((entry, i) => {
		...
		var finalLabelStyle = typeof labelStyle === "object" ? _objectSpread$40({}, labelStyle) : {};
...
var DefaultLegendContent = (outsideProps) => {
	...
	return /*#__PURE__*/ import_react.createElement("ul", {
		...
		style: finalStyle
	}, /*#__PURE__*/ import_react.createElement(Items, _extends$26({}, props, { payload })));
};
//#endregion
	...
	if (legendSettings && legendSize) {
		...
		if (position != null) {
			if (isOutsidePosition(position)) {
				if (position === "top" && isNumber(offset.top)) return _objectSpread$39(_objectSpread$39({}, offset), {}, { top: offset.top + (boxHeight || 0) + legendOffset });
				if (position === "bottom" && isNumber(offset.bottom)) return _objectSpread$39(_objectSpread$39({}, offset), {}, { bottom: offset.bottom + (boxHeight || 0) + legendOffset });
				if (position === "left" && isNumber(offset.left)) return _objectSpread$39(_objectSpread$39({}, offset), {}, { left: offset.left + (boxWidth || 0) + legendOffset });
				if (position === "right" && isNumber(offset.right)) return _objectSpread$39(_objectSpread$39({}, offset), {}, { right: offset.right + (boxWidth || 0) + legendOffset });
			}
			return offset;
		}
		if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber(offset[align])) return _objectSpread$39(_objectSpread$39({}, offset), {}, { [align]: offset[align] + (boxWidth || 0) });
		if ((layout === "horizontal" || layout === "vertical" && align === "center") && verticalAlign !== "middle" && isNumber(offset[verticalAlign])) return _objectSpread$39(_objectSpread$39({}, offset), {}, { [verticalAlign]: offset[verticalAlign] + (boxHeight || 0) });
	}
	return offset;
};
...
function getTooltipEntry(_ref4) {
	...
	return _objectSpread$39(_objectSpread$39({}, tooltipEntrySettings), {}, {
		dataKey,
		payload,
		value,
		name
...
var selectChartOffsetInternal = createSelector([
	...
	var offset = _objectSpread$38(_objectSpread$38({}, {
	...
	return _objectSpread$38(_objectSpread$38({ brushBottom }, offset), {}, {
...
var SizeDetectorContainer = /*#__PURE__*/ (0, import_react.forwardRef)((_ref2, ref) => {
	...
	return /*#__PURE__*/ import_react.createElement("div", _extends$25({
		...
		style: _objectSpread$37(_objectSpread$37({}, style), {}, {
			width,
			height,
			minWidth,
			minHeight,
...
var ResponsiveContainer = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	...
	return /*#__PURE__*/ import_react.createElement(SizeDetectorContainer, _extends$25({}, props, {
		width,
		height,
		ref
	}));
...
var _excluded$22 = ["contextPayload"];
...
function LegendContent(props) {
	var contextPayload = props.contextPayload, otherProps = _objectWithoutProperties$22(props, _excluded$22);
	var finalPayload = getUniqPayload(contextPayload, props.payloadUniqBy, defaultUniqBy$1);
	var contentProps = _objectSpread$36(_objectSpread$36({}, otherProps), {}, { payload: finalPayload });
...
function getDefaultPosition(style, props, margin, chartWidth, chartHeight, box) {
	...
	return _objectSpread$36(_objectSpread$36({}, hPos), vPos);
}
...
function LegendImpl(outsideProps) {
	...
	var outerStyle = portalFromProps ? wrapperStyle : _objectSpread$36(_objectSpread$36({
		position: "absolute",
	...
	var legendElement = /*#__PURE__*/ import_react.createElement("div", {
		...
		position: props.position,
		offset: props.offset
	}), shouldReportDimensions && /*#__PURE__*/ import_react.createElement(LegendSizeDispatcher, lastBoundingBox), /*#__PURE__*/ import_react.createElement(LegendContent, _extends$24({}, props, { layout }, widthOrHeight, {
		margin,
		chartWidth,
		chartHeight,
		contextPayload
...
var DefaultTooltipContent = (props) => {
	...
	var renderContent = () => {
		if (payload && payload.length) {
			...
			var items = lodashLikeSortBy(payload, itemSorter).map((entry, i) => {
				...
				var finalItemStyle = _objectSpread$35(_objectSpread$35({}, defaultDefaultTooltipContentProps.itemStyle), {}, { color: entry.color || defaultDefaultTooltipContentProps.itemStyle.color }, itemStyle);
	...
	var finalStyle = _objectSpread$35(_objectSpread$35({}, defaultDefaultTooltipContentProps.contentStyle), contentStyle);
...
function TooltipBoundingBoxImpl(props) {
	...
	var outerStyle = _objectSpread$34(_objectSpread$34({}, props.hasPortalFromProps ? {} : _objectSpread$34(_objectSpread$34({ transition: resolveTransitionProperty({
...
var getPath$1 = (_ref) => {
	...
	if (Array.isArray(baseLine)) {
		var _lineFunction;
		var areaPoints = points.map((entry, index) => _objectSpread$33(_objectSpread$33({}, entry), {}, { base: baseLine[index] }));
...
var Curve = (props) => {
	...
	return /*#__PURE__*/ import_react.createElement("path", _extends$22({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
...
var Cross = (_ref) => {
	var _ref$x = _ref.x, x = _ref$x === void 0 ? 0 : _ref$x, _ref$y = _ref.y, y = _ref$y === void 0 ? 0 : _ref$y, _ref$top = _ref.top, top = _ref$top === void 0 ? 0 : _ref$top, _ref$left = _ref.left, left = _ref$left === void 0 ? 0 : _ref$left, _ref$width = _ref.width, width = _ref$width === void 0 ? 0 : _ref$width, _ref$height = _ref.height, height = _ref$height === void 0 ? 0 : _ref$height, className = _ref.className, rest = _objectWithoutProperties$21(_ref, _excluded$21);
	var props = _objectSpread$32({
		x,
		y,
		top,
		left,
	...
	return /*#__PURE__*/ import_react.createElement("path", _extends$21({}, svgPropertiesAndEvents(props), {
...
var RechartsAnimation = class {
	...
	*/
	...
	constructor(param) {
		...
		_defineProperty$34(this, "state", INIT);
...
*/
var _excluded$20 = ["radius"];
var _excluded2$10 = ["radius"];
...
var Rectangle = (rectangleProps) => {
	...
	if (!isUpdateAnimationActive) {
		...
		var otherPathProps = _objectWithoutProperties$20(_svgPropertiesAndEven, _excluded$20);
		return /*#__PURE__*/ import_react.createElement("path", _extends$20({}, otherPathProps, {
			x: round(x),
			y: round(y),
			width: round(width),
			height: round(height),
	...
	return /*#__PURE__*/ import_react.createElement(JavascriptAnimate, {
		...
		var otherPathProps = _objectWithoutProperties$20(_svgPropertiesAndEven2, _excluded2$10);
		return /*#__PURE__*/ import_react.createElement("path", _extends$20({}, otherPathProps, {
			radius: typeof radius === "number" ? radius : void 0,
			className: layerClass,
			d: getRectanglePath(currX, currY, currWidth, currHeight, radius),
			ref: pathRef,
			style: _objectSpread$31(_objectSpread$31({}, animationStyle), props.style)
		}));
	});
};
//#endregion
...
var inRangeOfSector = (_ref5, viewBox) => {
	...
	if (inRange) return _objectSpread$30(_objectSpread$30({}, viewBox), {}, {
		radius,
...
var selectAngleAxis = createSelector([selectAngleAxisNoDefaults, selectPolarChartLayout], (angleAxisSettings, layout) => {
	...
	return _objectSpread$29(_objectSpread$29({}, implicitAngleAxis), {}, { type: evaluatedType });
});
...
var selectRadiusAxis = createSelector([selectRadiusAxisNoDefaults, selectPolarChartLayout], (radiusAxisSettings, layout) => {
	...
	return _objectSpread$29(_objectSpread$29({}, implicitRadiusAxis), {}, { type: evaluatedType });
});
...
var useTooltipAxisBandSize = () => {
	...
	return getBandSizeOfAxis(_objectSpread$25(_objectSpread$25({}, tooltipAxis), {}, { scale: tooltipAxisScale }), tooltipTicks);
};
//#endregion
...
var initialState$4 = { zIndexMap: Object.values(DefaultZIndexes).reduce((acc, current) => _objectSpread$23(_objectSpread$23({}, acc), {}, { [current]: {
	element: void 0,
...
function CursorInternal(props) {
	...
	var cursorProps = _objectSpread$22(_objectSpread$22(_objectSpread$22(_objectSpread$22({
		stroke: "#ccc",
		pointerEvents: "none"
...
function Cursor(props) {
	...
	return /*#__PURE__*/ import_react.createElement(CursorInternal, _extends$18({}, props, {
		offset,
		layout,
		tooltipAxisBandSize,
		chartName
		...
		var listener = (incomingSyncId, action, emitter) => {
			...
			if (syncMethod === "index") {
				...
				if (viewBox && action !== null && action !== void 0 && (_action$payload = action.payload) !== null && _action$payload !== void 0 && _action$payload.coordinate && action.payload.sourceViewBox) {
					var _action$payload$coord = action.payload.coordinate, _x = _action$payload$coord.x, _y = _action$payload$coord.y, otherCoordinateProps = _objectWithoutProperties$19(_action$payload$coord, _excluded$19);
					...
					var scaledCoordinate = _objectSpread$21(_objectSpread$21({}, otherCoordinateProps), {}, {
						x: viewBox.x + (sourceWidth ? (_x - sourceX) / sourceWidth : 0) * viewBox.width,
						y: viewBox.y + (sourceHeight ? (_y - sourceY) / sourceHeight : 0) * viewBox.height
					});
					dispatch(_objectSpread$21(_objectSpread$21({}, action), {}, { payload: _objectSpread$21(_objectSpread$21({}, action.payload), {}, { coordinate: scaledCoordinate }) }));
...
function Tooltip(outsideProps) {
	...
	var tooltipContentProps = _objectSpread$20(_objectSpread$20({}, props), {}, {
...
var LRUCache = class {
	constructor(maxSize) {
		_defineProperty$21(this, "cache", /* @__PURE__ */ new Map());
...
var currentConfig = _objectSpread$19({}, {
	cacheSize: 2e3,
	enableCache: true
});
...
_defineProperty$19(DecimalCSS, "NaN", new _DecimalCSS(NaN, ""));
...
var Text = /*#__PURE__*/ (0, import_react.forwardRef)((outsideProps, ref) => {
	...
	var dx = props.dx, dy = props.dy, angle = props.angle, className = props.className, breakAll = props.breakAll, textProps = _objectWithoutProperties$18(props, _excluded2$9);
	...
	return /*#__PURE__*/ import_react.createElement("text", _extends$17({}, svgPropertiesAndEvents(textProps), {
		ref,
		x,
		y,
...
var _excluded$17 = ["labelRef"];
var _excluded2$8 = ["content"];
...
function Label(outerProps) {
	...
	if (isPolar(viewBox)) {
		...
		positionAttrs = _objectSpread$18(_objectSpread$18({
			x: cartesianResult.x,
			y: cartesianResult.y,
	...
	return /*#__PURE__*/ import_react.createElement(ZIndexLayer, { zIndex: props.zIndex }, /*#__PURE__*/ import_react.createElement(Text, _extends$16({
		ref: labelRef,
...
var parseLabel = (label, viewBox, labelRef) => {
	...
	if (label === true) return /*#__PURE__*/ import_react.createElement(Label, _extends$16({ key: "label-implicit" }, commonProps));
	if (isNumOrStr(label)) return /*#__PURE__*/ import_react.createElement(Label, _extends$16({
		key: "label-implicit",
		value: label
	}, commonProps));
	if (/*#__PURE__*/ (0, import_react.isValidElement)(label)) {
		if (label.type === Label) return /*#__PURE__*/ (0, import_react.cloneElement)(label, _objectSpread$18({ key: "label-implicit" }, commonProps));
		return /*#__PURE__*/ import_react.createElement(Label, _extends$16({
			key: "label-implicit",
			content: label
		}, commonProps));
	}
	if (isLabelContentAFunction(label)) return /*#__PURE__*/ import_react.createElement(Label, _extends$16({
		key: "label-implicit",
		content: label
	}, commonProps));
	if (label && typeof label === "object") return /*#__PURE__*/ import_react.createElement(Label, _extends$16({}, label, { key: "label-implicit" }, commonProps));
	return null;
};
...
var _excluded$16 = ["valueAccessor"];
var _excluded2$7 = [
	"dataKey",
	"clockWise",
	"id",
...
function LabelList(_ref) {
	var _ref$valueAccessor = _ref.valueAccessor, valueAccessor = _ref$valueAccessor === void 0 ? defaultAccessor : _ref$valueAccessor, restProps = _objectWithoutProperties$16(_ref, _excluded$16), dataKey = restProps.dataKey;
	restProps.clockWise;
	var id = restProps.id, textBreakAll = restProps.textBreakAll, zIndex = restProps.zIndex, others = _objectWithoutProperties$16(restProps, _excluded2$7);
	...
	return /*#__PURE__*/ import_react.createElement(ZIndexLayer, { zIndex: zIndex !== null && zIndex !== void 0 ? zIndex : DefaultZIndexes.label }, /*#__PURE__*/ import_react.createElement(Layer, { className: "recharts-label-list" }, data.map((entry, index) => {
		...
		return /*#__PURE__*/ import_react.createElement(Label, _extends$15({ key: "label-".concat(index) }, svgPropertiesAndEvents(entry), others, idProps, {
...
function LabelListFromLabelProp(_ref2) {
	...
	if (typeof label === "object") return /*#__PURE__*/ import_react.createElement(LabelList, _extends$15({ key: "labelList-implicit" }, label, { type: String(label.type) }));
	return null;
}
//#endregion
...
var Dot = (props) => {
	...
	if (isNumber(cx) && isNumber(cy) && isNumber(r)) return /*#__PURE__*/ import_react.createElement("circle", _extends$14({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
		className: layerClass,
		cx,
		cy,
		r
...
var selectDisplayedData = createSelector([
	...
	if ((!displayedData || !displayedData.length) && cells != null) displayedData = cells.map((cell) => _objectSpread$17(_objectSpread$17({}, pieSettings.presentationProps), cell.props));
...
var SetPieTooltipEntrySettings = /*#__PURE__*/ import_react.memo((_ref) => {
	...
	var tooltipEntrySettings = {
		dataDefinedOnItem: sectors.map((sector) => {
			...
			return sectorTooltipPayload.map((item) => _objectSpread$15(_objectSpread$15({}, item), {}, {
...
var renderLabelLineItem = (option, props) => {
	...
	return /*#__PURE__*/ import_react.createElement(Curve, _extends$13({}, otherProps, {
		type: "linear",
		className
	}));
};
...
function PieSectors(props) {
	...
	var activeGraphicalItemId = useAppSelector(selectActiveTooltipGraphicalItemId);
	var onMouseEnterFromProps = allOtherPieProps.onMouseEnter, onItemClickFromProps = allOtherPieProps.onClick, onMouseLeaveFromProps = allOtherPieProps.onMouseLeave, restOfAllOtherProps = _objectWithoutProperties$15(allOtherPieProps, _excluded2$6);
...
function computePieSectors(_ref4) {
	...
	if (sum > 0) {
		...
		sectors = displayedData.map((entry, i) => {
			...
			var percent = (isNumber(val) ? val : 0) / sum;
			var tempStartAngle;
			var entryWithCellInfo = _objectSpread$15(_objectSpread$15({}, entry), cells && cells[i] && cells[i].props);
			...
			prev = _objectSpread$15(_objectSpread$15(_objectSpread$15(_objectSpread$15({}, pieSettings.presentationProps), {}, {
				percent,
...
var defaultPieAnimateItems = (items, animationElapsedTime) => {
	...
	items.forEach((item, index) => {
		...
		if (item.status === "matched") {
			...
			var latest = _objectSpread$15(_objectSpread$15({}, item.next), {}, {
			...
			var _latest = _objectSpread$15(_objectSpread$15({}, item.next), {}, {
				startAngle: curAngle + paddingAngle,
...
function PieImpl(props) {
	var id = props.id, propsWithoutId = _objectWithoutProperties$15(props, _excluded3$5);
	...
	return /*#__PURE__*/ import_react.createElement(ZIndexLayer, { zIndex: props.zIndex }, /*#__PURE__*/ import_react.createElement(SetPieTooltipEntrySettings, {
		...
		props: _objectSpread$15(_objectSpread$15({}, propsWithoutId), {}, { sectors }),
		previousSectorsRef,
		id
	})));
}
...
function PieFn(outsideProps) {
	...
	var externalId = props.id, propsWithoutId = _objectWithoutProperties$15(props, _excluded4$2);
	...
	}), /*#__PURE__*/ import_react.createElement(SetPiePayloadLegend, _extends$13({}, propsWithoutId, { id })), /*#__PURE__*/ import_react.createElement(PieImpl, _extends$13({}, propsWithoutId, { id }))));
}
var Pie = PieFn;
Pie.displayName = "Pie";
//#endregion
//#region node_modules/recharts/es6/component/Dots.js
var _excluded$14 = ["points"];
...
function DotItem(_ref) {
	...
	_ref2.points;
	var props = _objectWithoutProperties$14(_ref2, _excluded$14);
	return /*#__PURE__*/ import_react.createElement(Dot, _extends$12({}, props, { className: finalClassName }));
}
...
function Dots(_ref3) {
	...
	var dots = points.map((entry, i) => {
		...
		var dotProps = _objectSpread$14(_objectSpread$14(_objectSpread$14({ r: 3 }, baseProps), customDotProps), {}, {
			index: i,
	...
	return /*#__PURE__*/ import_react.createElement(ZIndexLayer, { zIndex }, /*#__PURE__*/ import_react.createElement(Layer, _extends$12({ className }, layerProps), dots));
}
//#endregion
	...
	reducers: {
		...
		updateYAxisWidth(state, action) {
			...
			if (axis) {
				...
				state.yAxis[id] = _objectSpread$13(_objectSpread$13({}, axis), {}, {
					width,
		...
		updateXAxisHeight(state, action) {
			...
			if (axis) {
				...
				state.xAxis[id] = _objectSpread$13(_objectSpread$13({}, axis), {}, {
					height,
...
var ActivePoint = (_ref) => {
	...
	var dotProps = _objectSpread$12(_objectSpread$12(_objectSpread$12({}, {
		index: childIndex,
		dataKey,
		cx: point.x,
		cy: point.y,
...
var combineAllBarPositions = (sizeList, globalMaxBarSize, barGap, barCategoryGap, barBandSize, bandSize, childMaxBarSize) => {
	...
	if (barBandSize !== bandSize && allBarPositions != null) allBarPositions = allBarPositions.map((pos) => _objectSpread$11(_objectSpread$11({}, pos), {}, { position: _objectSpread$11(_objectSpread$11({}, pos.position), {}, { offset: pos.position.offset - barBandSize / 2 }) }));
...
function AxisLine(axisLineProps) {
	...
	return /*#__PURE__*/ import_react.createElement("line", _extends$11({}, props, { className: clsx("recharts-cartesian-axis-line", get(axisLine, "className")) }));
}
/**
...
function TickItem(props) {
	...
	if (/*#__PURE__*/ import_react.isValidElement(option)) tickItem = /*#__PURE__*/ import_react.cloneElement(option, _objectSpread$9(_objectSpread$9({}, tickProps), {}, { className: combinedClassName }));
		...
		tickItem = /*#__PURE__*/ import_react.createElement(Text, _extends$11({}, tickProps, { className }), value);
	}
	return tickItem;
}
...
var Ticks = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	...
	var tickLines = tickLineCoords.map((_ref2) => {
		...
		}, tickLine && /*#__PURE__*/ import_react.createElement("line", _extends$11({}, tickLineProps, lineCoord, { className: clsx("recharts-cartesian-axis-tick-line", get(tickLine, "className")) })));
	});
...
var CartesianAxisComponent = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	var axisLine = props.axisLine, width = props.width, height = props.height, className = props.className, hide = props.hide, ticks = props.ticks, axisType = props.axisType, axisId = props.axisId, rest = _objectWithoutProperties$13(props, _excluded$13);
...
var CartesianAxis = /*#__PURE__*/ import_react.forwardRef((outsideProps, ref) => {
	...
	return /*#__PURE__*/ import_react.createElement(CartesianAxisComponent, _extends$11({}, props, { ref }));
});
...
var _excluded2$5 = ["offset"];
var _excluded3$4 = ["xAxisId", "yAxisId"];
...
function LineItem(_ref) {
	...
	if (/*#__PURE__*/ import_react.isValidElement(option)) lineItem = /*#__PURE__*/ import_react.cloneElement(option, lineItemProps);
		...
		var x1 = lineItemProps.x1, y1 = lineItemProps.y1, x2 = lineItemProps.x2, y2 = lineItemProps.y2, key = lineItemProps.key, _ref2 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(_objectWithoutProperties$12(lineItemProps, _excluded$12))) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {};
		_ref2.offset;
		var restOfFilteredProps = _objectWithoutProperties$12(_ref2, _excluded2$5);
		...
		lineItem = /*#__PURE__*/ import_react.createElement("line", _extends$10({}, restOfFilteredProps, {
			strokeDasharray,
			x1,
			y1,
			x2,
...
function HorizontalGridLines(props) {
	...
	props.xAxisId;
	props.yAxisId;
	var otherLineItemProps = _objectWithoutProperties$12(props, _excluded3$4);
...
function VerticalGridLines(props) {
	...
	props.xAxisId;
	props.yAxisId;
	var otherLineItemProps = _objectWithoutProperties$12(props, _excluded4$1);
...
function CartesianGrid(props) {
	...
	}), /*#__PURE__*/ import_react.createElement(HorizontalStripes, _extends$10({}, propsIncludingDefaults, { horizontalPoints })), /*#__PURE__*/ import_react.createElement(VerticalStripes, _extends$10({}, propsIncludingDefaults, { verticalPoints })), /*#__PURE__*/ import_react.createElement(HorizontalGridLines, _extends$10({}, propsIncludingDefaults, themeProps, {
		offset,
		horizontalPoints,
		xAxis,
		yAxis
	})), /*#__PURE__*/ import_react.createElement(VerticalGridLines, _extends$10({}, propsIncludingDefaults, themeProps, {
		offset,
		verticalPoints,
		xAxis,
		yAxis
...
function repeat(lines, count) {
	var result = [];
	for (var i = 0; i < count; ++i) result.push(...lines);
	return result;
}
/**
...
function computeAnimatedStrokeDasharray(userStrokeDasharray, totalLength, visibleLength) {
	if (userStrokeDasharray) return getStrokeDasharray(visibleLength, totalLength, "".concat(userStrokeDasharray).split(/[,\s]+/gim).map((num) => parseFloat(num)));
...
function LineDrawShape(props) {
	...
	props.isAnimating;
	props.isEntrance;
	var visibleLength = props.visibleLength, userStrokeDasharray = props.strokeDasharray, connectNulls = props.connectNulls, curveProps = _objectWithoutProperties$11(props, _excluded$11);
	...
	if (visibleLength != null) {
		...
		strokeDasharray = computeAnimatedStrokeDasharray(userStrokeDasharray, getTotalLength$1((_pathRef$current = pathRef === null || pathRef === void 0 ? void 0 : pathRef.current) !== null && _pathRef$current !== void 0 ? _pathRef$current : null), visibleLength);
	} else if (userStrokeDasharray != null) strokeDasharray = String(userStrokeDasharray);
	return /*#__PURE__*/ import_react.createElement(Curve, _extends$9({}, curveProps, {
...
function useAnimatedLineLength(points) {
	var startingLengthRef = (0, import_react.useRef)(0);
	var maxAnimatedLengthRef = (0, import_react.useRef)(0);
	var reachedFullRef = (0, import_react.useRef)(false);
	var prevPointsRef = (0, import_react.useRef)(points);
	if (prevPointsRef.current !== points) {
		startingLengthRef.current = maxAnimatedLengthRef.current;
		prevPointsRef.current = points;
	}
	return (0, import_react.useCallback)((animationElapsedTime, totalLength) => {
...
function averageShift(items) {
	var total = 0;
	var count = 0;
	for (var item of items) if (item.status === "matched" && item.prev.x != null && item.next.x != null) {
...
var defaultLineAnimateItems = (items, animationElapsedTime) => {
	...
	var result = [];
	for (var item of items) if (item.status === "matched") result.push(_objectSpread$7(_objectSpread$7({}, item.next), {}, {
		x: interpolate(item.prev.x, item.next.x, animationElapsedTime),
		y: interpolate(item.prev.y, item.next.y, animationElapsedTime)
	}));
	else if (item.status === "added") if (item.next.x != null) {
		var entryX = item.next.x - shift;
		result.push(_objectSpread$7(_objectSpread$7({}, item.next), {}, {
		...
		if (item.prev.x != null) {
			...
			result.push(_objectSpread$7(_objectSpread$7({}, item.prev), {}, {
...
var computeLegendPayloadFromAreaData = (props) => {
	var dataKey = props.dataKey, name = props.name, stroke = props.stroke, legendType = props.legendType;
	return [{
		inactive: props.hide,
		dataKey,
		type: legendType,
...
function LineDotsWrapper(_ref2) {
	...
	props.id;
	var lineProps = svgPropertiesNoEvents(_objectWithoutProperties$9(props, _excluded$9));
...
function StaticCurve(_ref4) {
	...
	var type = props.type, layout = props.layout, connectNulls = props.connectNulls, needClip = props.needClip, shape = props.shape, strokeDasharray = props.strokeDasharray;
	var curveProps = _objectSpread$7(_objectSpread$7({}, svgPropertiesAndEvents(_objectWithoutProperties$9(props, _excluded2$4))), {}, {
		fill: "none",
	...
	return /*#__PURE__*/ import_react.createElement(import_react.Fragment, null, (points === null || points === void 0 ? void 0 : points.length) > 1 && /*#__PURE__*/ import_react.createElement(Shape, {
		option: shape,
		DefaultShape: defaultLineProps.shape,
		shapeProps: curveProps
	}), /*#__PURE__*/ import_react.createElement(LineDotsWrapper, {
		points,
		clipPathId,
		props
	}));
...
function CurveWithAnimation(_ref5) {
	...
	var shouldUpdatePreviousRef = (0, import_react.useCallback)((animationElapsedTime) => animationElapsedTime > 0 && totalLength > 0, [totalLength]);
	return /*#__PURE__*/ import_react.createElement(LineLabelListProvider, {
		points,
		showLabels
	}, props.children, /*#__PURE__*/ import_react.createElement(AnimatedItems, {
...
function LineImpl(props) {
	...
	return /*#__PURE__*/ import_react.createElement(LineWithState, _extends$8({}, everythingElse, {
		id,
		connectNulls,
		dot,
		activeDot,
...
function computeLinePoints(_ref7) {
	var layout = _ref7.layout, xAxis = _ref7.xAxis, yAxis = _ref7.yAxis, xAxisTicks = _ref7.xAxisTicks, yAxisTicks = _ref7.yAxisTicks, dataKey = _ref7.dataKey, bandSize = _ref7.bandSize;
	return _ref7.displayedData.map((entry, index) => {
...
function LineFn(outsideProps) {
	...
	return /*#__PURE__*/ import_react.createElement(RegisterGraphicalItemId, {
		...
		hide: props.hide,
		isPanorama
	}), /*#__PURE__*/ import_react.createElement(LineImpl, _extends$8({}, props, { id }))));
}
/**
* @provides LabelListContext
...
//#endregion
export { XAxis as a, CartesianGrid as c, Tooltip as d, Legend as f, YAxis as i, Pie as l, BarChart as n, Bar as o, ResponsiveContainer as p, LineChart as r, Line as s, PieChart as t, Cell as u };
